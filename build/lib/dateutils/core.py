...
class DateUtils:
    ...
    @staticmethod
    def __parse_date(self, input_date):
    ...
    @staticmethod
    def __split_format(self, format_string):
        return re.split(r'([^\w])', format_string)
    
    @staticmethod
    def format_date(self, date_input, format_string):
        date_input = self.__parse_date(date_input)
        format_parts = self.__split_format(format_string)
        formatted = ""
    ...
    @staticmethod
    def convert_timezone(self, datetime_input, from_timezone, to_timezone):
        datetime_input = self.__parse_date(datetime_input)
    ...
    @staticmethod
    def add_time(self, datetime_input, **time_delta):
        datetime_input = self.__parse_date(datetime_input)
